            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div className="mt-2 text-gray-800 dark:text-white/90">
                ...
                <div className="relative inline-block mt-4 mb-6">
                  <div className="relative w-24 h-24 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 flex items-center justify-center w-8 h-8 bg-white border border-gray-200 rounded-full shadow-theme-sm text-gray-700 hover:bg-gray-50 dark:bg-gray-900 dark:border-gray-800 dark:text-gray-400"
                  >
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" value={user?.name?.split(" ").slice(1).join(" ") || ""} readOnly />
                  </div>
